...
from .translator import BleAdvTranslator
...
async def codec_to_code(config):
    ...
    cg.add(
        var.set_translator(await cg.get_variable(config[CONF_BLE_ADV_TRANSLATOR_ID]))
    )
...
BLE_ADV_CODECS = {
    ...
    "lampsmart_ios": {
        "variants": {
            "v1": {
                ...
                "ble_param": [0x19, 0x03],
                "header": [0x77, 0xF8],
                # 02.01.1A.1B.03.77.F8.B6.5F.2B.5E.00.FC.31.51.50.07.92.08.24.CB.3F.FC.24.B1.F4.47.8C.01.D4.02
            },
            "v1b": {
                "class": "FanLampEncoderV1",
                "translator": "default_translator_flv1",
                "args": [0x81, True, False, 0x55],
                "max_forced_id": 0xFFFFFF,
                "ble_param": [0x1A, 0x03],
                "header": [0xF9, 0x08],
                # 02.01.1A.1B.03.F9.08.49.13.F0.69.25.4E.31.51.BA.AE.25.02.99.C1.BA.7C.71.94.84.55.18.CA.EC.4C (31)
            },
            "v3": {
                "class": "FanLampEncoderV2",
                "translator": "default_translator_flv2",
                ...
                "ble_param": [0x19, 0x03],
                "header": [0xF0, 0x08],
                # 02.01.1A.1B.03.F0.08.20.80.0B.AA.DA.CF.F3.B5.A7.A0.3B.E8.1C.FC.27.A9.3A.94.3F.2D.3F.57.6D.DE
            },
            "v3b": {
                "class": "FanLampEncoderV2",
                "translator": "default_translator_flv2",
                "args": [[0x21, 0x80, 0x00], 0x0100, True],
                "ble_param": [0x19, 0x03],
                "header": [0xF0, 0x08],
                # 02.01.1A.1B.03.F0.08.21.80.0B.B5.DA.CF.F3.B5.A7.A0.3B.E9.1C.FC.27.A9.3A.34.0E.2D.3F.57.B9.81
            },
        },
        "default_variant": "v3",
        "default_forced_id": 0,
    ...
    # None of them are actually matching what FanLamp Pro / LampSmart Pro ANDROID apps are generating
