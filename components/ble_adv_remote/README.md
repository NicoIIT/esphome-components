...
## Description
Allows to capture BLE ADV Commands generated by Remotes or Phone Apps and either process actions or redirect those Commands to a [ble_adv_controller](../ble_adv_controller/README.md). Needs `ble_adv_handler` (forced include) to work.
